...
class HttpClient6 extends HttpClient
{
    ...
    public function sendSMS($messages)
    {
        ...
        $response = Out6::send($this->client, $request, $this->account, Out6::SMSArrayToSendRequestBody($messages));
    ...
    public function checkInbox($minId = 0, $minReceivedAt = null, $read = Inbox::INBOX_ALL, $line_number = null)
    {
        ...
        $response = Out6::send($this->client, new Request('GET', 'inbox'), $this->account, $query);
    ...
    public function checkStatus($opiloIds)
    {
        ...
        $response = Out6::send($this->client, new Request('GET', 'sms/status'), $this->account, ['ids' => $opiloIds]);
    ...
    {
        $response = Out6::send($this->client, new Request('GET', 'credit'), $this->account);
